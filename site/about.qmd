...
- **[Ubuntu](https://en.wikipedia.org/wiki/Ubuntu_philosophy):** **“A person is a person through other persons.”** The idea of *umuntu ngumuntu ngabantu* keeps learning connected to relationship, dignity, and community.
- **[“Each one, teach one.”](https://en.wikipedia.org/wiki/Each_one_teach_one)** Knowledge becomes more useful when it moves through people instead of stopping with the first person who receives it.
...
### Technology Commons emblem colours

These colours are used in the current Technology Commons emblem. They are kept as a distinct logo palette so the emblem can remain vibrant while the broader site, slide, handout, and interface palette stays more restrained.

::: {.brand-swatch-grid}
::: {.brand-swatch style="--swatch:#192346"}
<div class="brand-swatch-sample"></div>
**Emblem Navy**  
`#192346`
:::

::: {.brand-swatch style="--swatch:#30A2F1"}
<div class="brand-swatch-sample"></div>
**Emblem Sky Blue**  
`#30A2F1`
:::

::: {.brand-swatch style="--swatch:#F6E7D5"}
<div class="brand-swatch-sample"></div>
**Emblem Cream**  
`#F6E7D5`
:::

::: {.brand-swatch style="--swatch:#FD4F2F"}
<div class="brand-swatch-sample"></div>
**Emblem Coral**  
`#FD4F2F`
:::

::: {.brand-swatch style="--swatch:#014E9A"}
<div class="brand-swatch-sample"></div>
**Emblem Blue**  
`#014E9A`
:::

::: {.brand-swatch style="--swatch:#F9B901"}
<div class="brand-swatch-sample"></div>
**Emblem Gold**  
`#F9B901`
:::
