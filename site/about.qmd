...
## Why this should be open-source and free

The goal is simple: useful teaching and learning material should be **open-source, free to access, and easy to adapt**. Learners, educators, and anyone else who can use it should not have to pay for basic knowledge or depend on access to a single classroom, platform, or account.
...
- **The Way:** I use *the Way* here in a broad, non-doctrinal sense: work with things as they are and let the path become clearer through practice. Try to meet the work non-judgmentally, do one thing mindfully, act effectively, and accept what is present without becoming attached to a particular outcome. Different traditions use the idea of a way or path differently, and those differences matter.
