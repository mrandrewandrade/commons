...
The Technology Commons brand is meant to feel **sleek, disciplined, technical, calm, and useful**. The visual language borrows from military and industrial systems through strong grids, compact labels, deep neutrals, and controlled accents. Wellness greens soften that structure. Port Credit blues and yellows keep the system connected to the school. Purple and red are reserved for specific kinds of emphasis.
...
### Core neutrals and military base

Use these most often for structure, text, backgrounds, dividers, and interface surfaces.
...
### Institutional and technical blues

Blue is the main institutional family. The darkest blues connect visually to PCSS and SciTech marks. Technical Blue is the preferred interactive and data accent.
...
Green is for wellness, reflection, positive progress, environmental themes, calm status, and moments where the interface should feel less institutional.
...
### School and warm accents

Yellow and gold connect strongly to the supplied Port Credit and SciTech badges. Brass and copper give the Commons a more mature industrial accent when bright school yellow would be too energetic.
...
| Mode | Use |
|---|---|
| **Commons core** | Off Black + Soft White + Warriors Navy + Technical Blue |
| **Wellness** | Off Black + Soft White + Moss + Sea Glass |
| **Port Credit spirit** | Warriors Navy + PCSS Yellow + white |
| **SciTech** | SciTech Navy + Technical Blue + SciTech Gold |
| **Reflection / creativity** | Off Black + Soft White + Iris Purple |
| **Urgent / important** | Off Black + Soft White + Signal Red, used sparingly |
| **Industrial / mature** | Carbon + Soft White + Copper or Brass |
